<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cbtrial3.aspx.cs" Inherits="WebApplication2.cbtrial3" %>
...
<p>
        <asp:Button ID="Button1"  style="margin-left: 280px" runat="server"  Text="PREDICT" OnClick="Button1_Click" BorderColor="Black" BorderWidth="5px" ForeColor="Black" Width="423px" />
        <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="R script code" />
        </p>
    </div>
